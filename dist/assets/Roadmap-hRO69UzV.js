import{r as l,j as e}from"./index-k91argOO.js";const x=[{id:1,code:"P1",title:"Foundation Fixes",subtitle:"Deploy pipeline · vite config · asset paths",priority:"CRITICAL",duration:"1 Day",color:"#E24B4A",bg:"#500000",accent:"#ff6b6b",icon:"⚡",outcome:"Site renders live on GitHub Pages",steps:[{id:"1.1",title:"Fix vite.config.js — add base path",tag:"BUG",tagColor:"#E24B4A",desc:"✅ DONE — vite.config.js already has base: '/FriendsGroup/' in the repo. This was the #1 deploy blocker and it has been resolved. The site now loads on GitHub Pages.",code:`// vite.config.js
